...
export class JetsSeatMapService {
  constructor(configuration) {
    const { apiUrl, apiAppId, apiKey, colorTheme, apiAuthorizationScheme, request } = configuration;

    const localStorage = new JetsLocalStorageService();
    this._api = new JetsSeatMapApiService(apiAppId, apiKey, apiUrl, localStorage, apiAuthorizationScheme, request);
