...
class He {
    ...
    l(this, '_dataHelper', null),
      ...
      l(this, '_prepareSeatFeatures', (e, t, r) => {
        const { pitch: l, width: i, recline: o, audioVideo: s, power: a, wifi: n } = t,
          ...
          u = { pitch: c || l, width: d || i, recline: m ? '- -' : h || o },
          f = ['+', '-'];
        return {
      ...
      l(this, 'prepareSeatAdditionalProps', e => {
        ...
        return null == t
          ? void 0
          : t.map(e => ({
              icon: Te[(null == e ? void 0 : e.icon) || 'dot'] || '',
              title: null,
              uniqId: Se.generateId(),
  ...
  _updateDeckItemsTopOffset(e, t, r = 0) {
    return e[t].map(e => {
      const t = { ...e, uniqId: Se.generateId() },
        l = t.topOffset + r;
  ...
  _prepareDeck(e, t, r, l, i) {
    ...
    return { uniqId: Se.generateId(), width: d, height: h, level: e.level, rows: c, wingsInfo: g };
  }
...
const Ve = 'chrome',
  Oe = () => {
    const [t, r, l, i] = e.useMemo(() => {
      ...
      return [e.includes('firefox'), e.includes(Ve), e.includes('safari') && !e.includes(Ve), e.includes('edge')];
    }, []);
...
const Ke = ct(Array.prototype.forEach),
  ...
  tt = ct(String.prototype.match),
  rt = ct(String.prototype.replace),
  lt = ct(String.prototype.indexOf),
  it = ct(String.prototype.trim),
  ot = ct(Object.prototype.hasOwnProperty),
  st = ct(RegExp.prototype.test),
  at =
    ((nt = TypeError),
    function () {
...
var Rt = (function e() {
  ...
  let de = null;
  const he = dt({}, ['audio', 'video', 'img', 'source', 'image', 'track']);
  let ge = null;
  const pe = dt({}, [
      'alt',
      'class',
  ...
  return (
    ...
    (r.setConfig = function () {
      He(arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}), (X = !0);
    }),
...
const jt = ({ iconType: t }) => {
  ...
  const [i, o] = e.useState(''),
    s = e.useRef(),
    { params: a, colorTheme: n, config: c } = e.useContext(xe),
    { bulkIconColor: d } = n,
...
const Zt = { 26: 1, 27: 1, 28: 1 },
  Ut = ({ id: t, type: l, align: i, width: o, height: s, iconType: a, xOffset: n, topOffset: c }) => {
    var d, h, g;
    ...
    getSeatIcon(e, t) {
      ...
      if (i <= 4)
        switch (r) {
          ...
          case 'P':
            return Qt.getTemplate(t);
          default:
            return er.getTemplate(i, t);
        }
...
const or = ({ seats: t, top: l }) => {
  ...
  const o = e.useRef(null),
    { componentOverrides: s } = e.useContext(xe),
    a = null !== (i = null == s ? void 0 : s.JetsSeat) && void 0 !== i ? i : ir;
  return r.default.createElement(
    'div',
...
const sr = ({ top: t, height: l, lang: i, localeKey: o }) => {
  ...
  return r.default.createElement(
    'div',
    { className: 'jets-cabin-title-container', style: g, ref: c },
    r.default.createElement(
      'div',
...
const ar = 'deck',
  nr = ({ deck: t, lang: l, exits: i, bulks: o, isSingleDeck: s }) => {
    const { rows: a, number: n, height: c, width: d, wingsInfo: h } = t || {},
      { params: g } = e.useContext(xe),
      p = e.useRef(null),
    ...
    return r.default.createElement(
      ...
      i && i.length
        ? i.map(({ topOffset: e, type: t, uniqId: l }, i) =>
            r.default.createElement(Kt, { key: l, type: t, index: i, topOffset: e })
          )
        : null,
      o && o.length
        ? o.map(({ id: e, uniqId: t, type: l, align: i, width: o, height: s, iconType: a, xOffset: n, topOffset: c }) =>
            r.default.createElement(Ut, {
              id: e,
              key: t,
              type: l,
              align: i,
...
const wr = ({ data: t }) => {
    ...
    const ae = null != c && c.isHorizontal ? 'left' : 'top',
      ne = null != c && c.isHorizontal ? 'width' : 'height',
      ce = le[ae] + 0.5 * le[ne],
      de = m < oe,
      he = ee[ae] > ce,
      ge = Number(se > g),
      pe = Number(de) * Number(he),
      me = g - ie,
      Ce = Math.min(me - 16, 0),
      ue = g - me + Ce - -16 / 6,
      fe = oe + X - (m + X + 14) * pe,
      ke = ie + X - (g + X + 14) * ge,
      ve = {
        maxHeight: null != c && c.isHorizontal ? G : 'auto',
        maxWidth: null != c && c.isHorizontal ? 1.5 * K : 'auto',
        width: null != c && c.isHorizontal ? 'auto' : U,
    ...
    e.useLayoutEffect(() => {
      f(h.current.getBoundingClientRect().top - document.body.getBoundingClientRect().top),
    ...
    return r.default.createElement(
      ...
      {
        style: ve,
        className: 'jets-tooltip ' + (null != c && c.isHorizontal ? 'horizontal' : ''),
        ref: h,
        ...
        r.default.createElement(
          ...
          r.default.createElement(
            ...
            r.default.createElement(
              'ul',
              null,
              Te.map(({ uniqId: e, title: t, icon: l, value: i, cssClass: o }) =>
                r.default.createElement(
                  'li',
              ...
              Te.length % 2 == 1 && r.default.createElement('li', { className: 'jets-tooltip--feature' }, ' ')
            )
          ),
          r.default.createElement(
            'div',
  ...
  br = ({
    ...
    e.useEffect(() => {
      ...
      e.useEffect(() => {
        if (!l) return;
        const e = Z.setAvailabilityHandler(x, l),
          t = l.map(({ label: e }) => e),
          r = Z.compareWithDecksSeatsInfo(t, e);
        X(), M(e), H(null), C(r);
      }, [l]),
      e.useEffect(() => {
        X(), H(null);
    ...
    const K = e.useMemo(
      ...
      X = () => {
        ...
        const e = Z.setPassengersHandler(x, i || []);
        M(e), T(i);
      },
      Q = () => {
        if (!B) return;
      ...
      le = e => {
        const { data: t, passengers: r } = Z.unselectSeatHandler(x, e, S);
        M(t), T(r), H(null), d(r);
      },
      ie = e => {
        var t, r;
        const l = Z.getNextPassenger(S);
        return (
          !l ||
    ...
    return r.default.createElement(
      ...
      r.default.createElement(
        ...
        E && r.default.createElement(wr, { data: E }),
        G && r.default.createElement(cr, { direction: !!O }),
        r.default.createElement(
          'div',
...
br.defaultProps = {
  config: {
    ...
    colorTheme: {
      ...
      fuselageStrokeColor: te,
      fuselageStrokeWidth: 12,
      fuselageWindowsColor: re,
      fuselageWingsColor: le,
      defaultPassengerBadgeColor: ie,
      fontFamily: oe,
      deckHeightSpacing: 200,
      wingsWidth: 30,
      deckSeparation: 50,
      tooltipBackgroundColor: se,
      tooltipHeaderColor: ae,
      tooltipBorderColor: ne,
      tooltipFontColor: ce,
      tooltipIconColor: de,
      tooltipIconBorderColor: he,
      tooltipIconBackgroundColor: ge,
      tooltipSelectButtonTextColor: pe,
      tooltipSelectButtonBackgroundColor: me,
      tooltipCancelButtonTextColor: Ce,
      tooltipCancelButtonBackgroundColor: ue,
      deckSelectorStrokeColor: ke,
      deckSelectorFillColor: fe,
      deckSelectorSize: 25,
      exitIconUrlLeft: null,
      exitIconUrlRight: null,
      cabinTitlesWidth: 80,
      cabinTitlesHighlightColors: we,
      cabinTitlesLabelColor: ve,
    },
  },
  onSeatMapInited: e => {
...
(exports.BULK_TEMPLATE_MAP = Ie),
  ...
  (exports.DEFAULT_EXTERNAL_PASSENGER_MANAGEMENT = O),
  ...
  (exports.THEME_CABIN_TITLES_LABEL_COLOR = ve),
  (exports.THEME_CABIN_TITLES_WIDTH = 80),
  (exports.THEME_DECK_HEIGHT_SPACING = 200),
  (exports.THEME_DECK_LABEL_TITLE_COLOR = U),
  (exports.THEME_DECK_SELECTOR_FILL_COLOR = fe),
  (exports.THEME_DECK_SELECTOR_SIZE = 25),
  (exports.THEME_DECK_SELECTOR_STROKE_COLOR = ke),
  ...
  (exports.THEME_TOOLTIP_CANCEL_BUTTON_BACKGROUND_COLOR = ue),
  (exports.THEME_TOOLTIP_CANCEL_BUTTON_TEXT_COLOR = Ce),
  (exports.THEME_TOOLTIP_FONT_COLOR = ce),
  (exports.THEME_TOOLTIP_HEADER_COLOR = ae),
  (exports.THEME_TOOLTIP_ICON_BACKGROUND_COLOR = ge),
  (exports.THEME_TOOLTIP_ICON_BORDER_COLOR = he),
  (exports.THEME_TOOLTIP_ICON_COLOR = de),
  (exports.THEME_TOOLTIP_SELECT_BUTTON_BACKGROUND_COLOR = me),
